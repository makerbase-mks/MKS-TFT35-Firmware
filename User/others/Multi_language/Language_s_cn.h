...
#define CUSTOM_CONFIG_CN			"定制效果"
#define CONSOLE_CN					"Gcode"
...
#define MACHINE_CNDSTOP_TYPE_CN					"限位开关类型"
#define MACHINE_FILAMENT_CONFIG_CN			"换料设置"
#define MACHINE_LEVELING_CONFIG_CN			"调平设置"
#define MACHINE_BAUDRATE_CONFIG_CN			"波特率设置"
#define MACHINE_FIRMWARE_CONFIG_CN	"固件类型"
#define MACHINE_PAUSEPOSI_CONFIG_CN "暂停位置设置"
#define MACHINE_WIFI_CONFIG_CN      "Wifi设置"
...
#define MACHINE_TYPE_NORMAL_CN				"通用机型"

#define FIRMWARE_TYPE_CONFIG_TITLE_CN		"机器参数>固件类型"
#define FIRMWARE_TYPE_MARLIN_CN					"Marlin"
#define FIRMWARE_TYPE_REPETIER_CN				"Repetier"
#define FIRMWARE_TYPE_SMOOTHIE_CN				"Smoothie"

#define BAUD_RATE_CONFIG_TITLE_CN		"机器参数>波特率设置"
...
#define PAUSE_POSITION_CONF_TITLE_CN				"机器参数>暂停位置"
#define POSITION_X_CN						"X轴暂停位置"
#define POSITION_Y_CN						"Y轴暂停位置"
#define POSITION_Z_CN						"Z轴暂停位置(相对位置)"

#define WIFI_CONFIG_TILE_CN    				"机器参数>Wifi设置"
#define WIFI_MODE_SEL_CN					"wifi模式"
#define WIFI_NAME_SET_CN					"Ap名称"
#define WIFI_KEY_SET_CN						"Ap密码"
#define WIFI_CLOUD_CNABLE_CN					"云服务"
#define WIFI_CLOUD_ADDR_CN						"云服务网址"
#define WIFI_CLOUD_PORT_CN					"云端口"
#define WIFI_MODE0_CN						"Sta"
#define WIFI_MODE1_CN						"AP"
#define TEXT_SEND_CN 						"发送"					
#define ENDSTOP_CONF_TITLE_CN						"机器参数>限位开关"
#define MIN_CNDSTOP_X_CN											"X轴最小限位"
#define MIN_CNDSTOP_Y_CN											"Y轴最小限位"
#define MIN_CNDSTOP_Z_CN											"Z轴最小限位"
#define MAX_CNDSTOP_X_CN											"X轴最大限位"
#define MAX_CNDSTOP_Y_CN											"Y轴最大限位"
#define MAX_CNDSTOP_Z_CN											"Z轴最大限位"
...
#define BLTOUCH_LEVELING_CNABLE_CN			"启动BLtouch"
...
#define LEVELING_Z_SPEED_CN					"Z轴调平速度"
#define LEVELING_Z_HIGH_CN					"Z轴调平高度"
#define LEVELING_XY_SPEED_CN				"xy轴调平速度"
#define AUTOLEVELCMD_CN						"自动调平指令"
#define LEVELING_POINTS_TEXT_CN				"调平点数量"
...
#define NOZZLE_MIN_TEMPERATURE_CN			"喷头最低温度(℃)"
#define NOZZLE_MAX_TEMPERATURE_CN			"喷头最高温度(℃)"
#define EXTRUD_MIN_TEMPER_CN					"最低挤出温度(℃)"

#define HOTBED_CONF_TITLE_CN					"机器参数>热床设置"
#define HOTBED_ADJUST_CN								"PID调温"
#define HOTBED_MIN_TEMPERATURE_CN				"热床最低温度(℃)"
#define HOTBED_MAX_TEMPERATURE_CN				"热床最高温度(℃)"
...
#define CURRENTCONF_CN					"TMC驱动电流设置"
#define TMCBUMPCONF_CN					"TMC碰撞灵敏度"
#define SAVETOEEPROM_CN					"保存修改到固件"
#define GETEEPROM_CN					"获取固件参数"
...
#define CURRENT_CONF_TITLE_CN						"机器设置>TMC驱动电流设置"
#define X_CURRENT_CN								"X轴电流(mA)"
#define Y_CURRENT_CN								"Y轴电流(mA)"
#define Z_CURRENT_CN								"Z轴电流(mA)"
#define E0_CURRENT_CN								"E0轴电流(mA)"
#define E1_CURRENT_CN								"E1轴电流(mA)"

#define TMC_CONF_TITLE_CN						"机器设置>TMC碰撞灵敏度设置"
#define X_SENSITIVITY_CN								"X轴TMC碰撞灵敏度"
#define Y_SENSITIVITY_CN								"Y轴TMC碰撞灵敏度"
#define Z_SENSITIVITY_CN								"Z轴TMC碰撞灵敏度"
...
#define BREAKPOINT_Z_ERROR_CN					"断点续打Z轴误差"
#define LEVEL_PB0_CONF_CN						"断料接口PB0电平"
#define LEVEL_PB1_CONF_CN						"断料接口PB1电平"
#define DISABLE_PB1_PB0_CONF_CN					"是否取消断料检测"
#define OFF_SAVE_MODE_CN						"断电保存方式"
#define OFF_SAVE_MODE1_CN						"电容"
#define OFF_SAVE_MODE2_CN						"文件"
#define LEVEL_HIGH_CN							"高"
#define LEVEL_LOW_CN							"低"

#define CUSTOMCONF_TITLE_CN						"屏幕参数>定制"
#define DISPLAY_CONF_CN							"显示配置"
#define BUTTON_CONF_CN							"按钮定制"

#define DISPLAY_TITLE_CN						"显示设置"
#define BUTTON_3D_CN							"按钮3D效果"
#define BTN_TEXT_OFFSET_CN						"按钮字体偏移"
#define SCREEN_OVERTURN_CN                      "屏幕翻转180"
#define DISPLAY_MODE_CN							"首页显示模式"
#define ENABLE_ERROR_MSG_CN						"是否开启报错功能"
#define ENABLE_BABASTEPTING_CN						"是否开启Babasteping功能"
#define SIMPLETHEME_CN							"简约模式"
#define CLASSICTHEME_CN							"经典模式"

#define BUTTON_TITLE_CN						"按钮定制"

#define PRINT_MORE_BTN_TITLE_CN	    			"操作界面按钮定制"
#define MORE_BTN_TITLE_CN						"更多界面按钮定制"
#define BUTTON_COUNT_CN							"定制按钮数量"
#define BUTTON1_NAME_CN							"按钮1"
#define BUTTON2_NAME_CN							"按钮2"
#define BUTTON3_NAME_CN							"按钮3"
#define BUTTON4_NAME_CN							"按钮4"
#define BUTTON5_NAME_CN							"按钮5"
#define BUTTON6_NAME_CN							"按钮6"
#define BUTTON7_NAME_CN							"按钮7"
#define DISPLAY_FUNCTIONBTN1_CN					"是否显示功能按钮1"
#define FUNCTION_BTN1_TEXT_CN					"功能按钮1指令"
#define DISPLAY_QUICKSTOP_CN					"是否显示急停按钮"
#define DISPLAY_ZOFFSET_CN						"显示Z Offset按钮"
#define DISPLAY_CALIBRATE_CN 					"显示校准按钮"

#define Z2_AND_Z2ENDSTOP_CONF_TITLE_CN  				"双z双限位设置"
#define Z2_CNABLE_CN											 "启用Z2轴"
#define Z2_CNDSTOP_CN											"启用Z2限位"
#define Z2_PORT_CN													"Z2限位接口"

#define ENABLE_PINS_CONF_TITLE_CN					"电机使能脚电平"
#define X_CNABLE_PINS_INVERT_CN						"X轴电机使能电平"
#define Y_CNABLE_PINS_INVERT_CN						"Y轴电机使能电平"
#define Z_CNABLE_PINS_INVERT_CN						"Z轴电机使能电平"
#define E_CNABLE_PINS_INVERT_CN						"E轴电机使能电平"
...
#define MOTOR_CN_HIGH_LEVEL_CN  "高"
#define MOTOR_CN_LOW_LEVEL_CN  "低"
