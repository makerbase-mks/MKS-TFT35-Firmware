...
#endif
#define MOTHERBOARD 519		//modify 1
#define NO_DISPLAY  0
...
//Menson
#define UI_ACTION_INC_FEEDRATE_MULTIPLY		5000
#define UI_ACTION_DEC_FEEDRATE_MULTIPLY		5001
#define UI_ACTION_INC_EXTRUCTOR_MULTIPLY	5002
#define UI_ACTION_DEC_EXTRUCTOR_MULTIPLY	5003
/*
...
class UIDisplay {
  public:
   ...
   // static uint8_t sd_pause_flag,sd_continue_flag;
...
void uiCheckKeys(uint16_t &action) {
	...
	extern volatile uint16_t osAnalogInputValues[9];
	//uint16_t adc = osAnalogInputValues[KEYPAD_ANALOG_INDEX] >> (ANALOG_REDUCE_BITS);
	uint16_t adc = osAnalogInputValues[Change_Repetier_Define.def_KEYPAD_ANALOG_INDEX] >> (ANALOG_REDUCE_BITS);
	if (adc < 4000) {
